package ddt.view.common
{
   ...
   public class VipLevelIcon extends Sprite implements ITipedDisplay, Disposeable
   {
      ...
      private var _vipIcon:ScaleFrameImage;
      ...
      public function VipLevelIcon()
      {
         ...
         this._vipIcon = ComponentFactory.Instance.creatComponentByStylename("core.VipLevelIcon");
         addChild(this._vipIcon);
         ShowTipManager.Instance.addTip(this);
      }
      
      public function setInfo(param1:PlayerInfo, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         if(param1.ID == PlayerManager.Instance.Self.ID)
         {
            if(param2)
            {
               if(param3)
               {
                  ...
                  else if(!PlayerManager.Instance.Self.IsVIP && PlayerManager.Instance.Self.VIPExp > 0)
                  {
