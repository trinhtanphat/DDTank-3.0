...
Require-Text '''game.objects.GameLocalPlayer,game.view.VaneView,ddt.manager.PathManager,game.view.Bomb,ddt.utils.RequestVairableCreater''' 'Expected client classes are not selected for patching.'
