...
Require-Text '''game.objects.GameLocalPlayer,game.view.VaneView,ddt.manager.PathManager,game.view.Bomb''' 'Expected client classes are not selected for patching.'
