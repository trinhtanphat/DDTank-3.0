...
$tcpFiles=@('Bussiness\app.config','Center.Service\App.config','Game.Service\App.config','GameAdmin\Web.config','Tank.Request\Tank.Request\Web.config','Tank.Request\Web.config')
...
Write-Host 'PASS: DDTank30 deploy-graph CenterService WCF endpoints are isolated on 2308/2309.'